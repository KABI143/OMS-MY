...
// Handling the report query
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['generate_report'])) {
    $from_date = $_POST['from_date'];
    $to_date = $_POST['to_date'];

    // Adjust the column name if needed (use correct column name for oil type)
    $query = "SELECT date, oil_name, machine_name, quantity_used, used_by, used_reason FROM oil_usage WHERE date BETWEEN '$from_date' AND '$to_date'";
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            $oil_name = !empty($row['oil_name']) ? $row['oil_name'] : 'N/A';
                            echo "<tr>
                                    <td>" . $row['date'] . "</td>
                                    <td>" . htmlspecialchars($oil_name) . "</td>
