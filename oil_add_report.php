...
<body>
   ...
   <div class="sidebar">
        ...
        <a href="usage_oil.php"><i class="fa-solid fa-oil-well"></i> Usage Oil</a>
        <h3>Reports</h3>
        <a href="oil_add_report.php"><i class="fa-solid fa-file-invoice"></i> Oil Add Report</a>
        <a href="oil_usage_report.php"><i class="fa-solid fa-file-invoice"></i> Oil Usage Report</a>
    </div>

    <!-- Header -->
    <header>
        <img class="logo-left" src="assets/taro.png" alt="Left Logo">
        <h1>HYDRAULIC OIL MANAGEMENT - REPORT</h1>
